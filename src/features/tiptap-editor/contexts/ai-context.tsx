...
import { fetchAiToken, getUrlParam } from "@/features/tiptap-editor/lib/tiptap-collab-utils";
...
export const useAiToken = () => {
  ...
  useEffect(() => {
    ...
    const getToken = async () => {
      const token = await fetchAiToken(TIPTAP_AI_TOKEN);
      setAiToken(token);
    };
