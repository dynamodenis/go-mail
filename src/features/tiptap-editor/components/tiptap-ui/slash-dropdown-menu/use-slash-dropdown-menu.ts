...
// --- Icons ---
import { CodeBlockIcon } from "@/features/tiptap-editor/components/tiptap-icons/code-block-icon";
import { HeadingOneIcon } from "@/features/tiptap-editor/components/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "@/features/tiptap-editor/components/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "@/features/tiptap-editor/components/tiptap-icons/heading-three-icon";
import { ImageIcon } from "@/features/tiptap-editor/components/tiptap-icons/image-icon";
import { ListIcon } from "@/features/tiptap-editor/components/tiptap-icons/list-icon";
import { ListOrderedIcon } from "@/features/tiptap-editor/components/tiptap-icons/list-ordered-icon";
import { BlockquoteIcon } from "@/features/tiptap-editor/components/tiptap-icons/blockquote-icon";
import { ListTodoIcon } from "@/features/tiptap-editor/components/tiptap-icons/list-todo-icon";
import { AiSparklesIcon } from "@/features/tiptap-editor/components/tiptap-icons/ai-sparkles-icon";
import { MinusIcon } from "@/features/tiptap-editor/components/tiptap-icons/minus-icon";
import { TypeIcon } from "@/features/tiptap-editor/components/tiptap-icons/type-icon";
import { AtSignIcon } from "@/features/tiptap-editor/components/tiptap-icons/at-sign-icon";
import { SmilePlusIcon } from "@/features/tiptap-editor/components/tiptap-icons/smile-plus-icon";
import { TableIcon } from "@/features/tiptap-editor/components/tiptap-icons/table-icon";

// --- Lib ---
import {
  isExtensionAvailable,
  isNodeInSchema,
} from "@/features/tiptap-editor/lib/tiptap-utils";
import {
  findSelectionPosition,
  hasContentAbove,
} from "@/features/tiptap-editor/lib/tiptap-advanced-utils";

// --- Tiptap UI ---
import type { SuggestionItem } from "@/features/tiptap-editor/components/tiptap-ui-utils/suggestion-menu";
import { addEmojiTrigger } from "@/features/tiptap-editor/components/tiptap-ui/emoji-trigger-button";
import { addMentionTrigger } from "@/features/tiptap-editor/components/tiptap-ui/mention-trigger-button";
...
const getItemImplementations = () => {
  return {
    ...
    image: {
      ...
      action: ({ editor }: { editor: Editor }) => {
        // Use requestAnimationFrame to ensure we're not in the middle of a Yjs sync
        // This helps prevent conflicts with existing document state in collaborative editing
        requestAnimationFrame(() => {
          editor
            .chain()
            .focus()
