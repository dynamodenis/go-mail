...
import {
  TEXT_COLORS,
  useColorText,
} from "@/features/tiptap-editor/components/tiptap-ui/color-text-button";
import {
  HIGHLIGHT_COLORS,
  useColorHighlight,
} from "@/features/tiptap-editor/components/tiptap-ui/color-highlight-button";
import type { RecentColor } from "@/features/tiptap-editor/components/tiptap-ui/color-text-popover";
import {
  getColorByValue,
  useRecentColors,
} from "@/features/tiptap-editor/components/tiptap-ui/color-text-popover";

// Icons
import { PaintBucketIcon } from "@/features/tiptap-editor/components/tiptap-icons/paint-bucket-icon";
import { ChevronRightIcon } from "@/features/tiptap-editor/components/tiptap-icons/chevron-right-icon";
import { TextColorSmallIcon } from "@/features/tiptap-editor/components/tiptap-icons/text-color-small-icon";
