...
// --- Icons ---
import { AlignCenterVerticalIcon } from "@/features/tiptap-editor/components/tiptap-icons/align-center-vertical-icon";
import { AlignEndVerticalIcon } from "@/features/tiptap-editor/components/tiptap-icons/align-end-vertical-icon";
import { AlignStartVerticalIcon } from "@/features/tiptap-editor/components/tiptap-icons/align-start-vertical-icon";
...
export function useImageAlign(config: UseImageAlignConfig) {
  ...
  const canAlign = canSetImageAlign(
    editor,
    align,
    extensionName,
    attributeName
