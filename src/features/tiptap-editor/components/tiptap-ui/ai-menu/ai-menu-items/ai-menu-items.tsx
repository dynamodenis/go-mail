...
import {
  ...
  useAiMenuState,
} from "@/features/tiptap-editor/components/tiptap-ui/ai-menu";
...
import { ComboboxList } from "@/features/tiptap-editor/components/tiptap-ui-primitive/combobox";
import { Separator } from "@/features/tiptap-editor/components/tiptap-ui-primitive/separator";

import {
  SUPPORTED_LANGUAGES,
  SUPPORTED_TONES,
} from "@/features/tiptap-editor/components/tiptap-ui/ai-menu/ai-menu-items/ai-menu-items-constants";
import type {
  EditorMenuAction,
  ...
  NestedMenuAction,
} from "@/features/tiptap-editor/components/tiptap-ui/ai-menu/ai-menu-items/ai-menu-items-types";

// -- Icons --
import { ChevronRightIcon } from "@/features/tiptap-editor/components/tiptap-icons/chevron-right-icon";
import { SummarizeTextIcon } from "@/features/tiptap-editor/components/tiptap-icons/summarize-text-icon";
import { Simplify2Icon } from "@/features/tiptap-editor/components/tiptap-icons/simplify-2-icon";
import { LanguagesIcon } from "@/features/tiptap-editor/components/tiptap-icons/languages-icon";
import { MicAiIcon } from "@/features/tiptap-editor/components/tiptap-icons/mic-ai-icon";
import { TextExtendIcon } from "@/features/tiptap-editor/components/tiptap-icons/text-extend-icon";
import { TextReduceIcon } from "@/features/tiptap-editor/components/tiptap-icons/text-reduce-icon";
import { CompleteSentenceIcon } from "@/features/tiptap-editor/components/tiptap-icons/complete-sentence-icon";
import { SmileAiIcon } from "@/features/tiptap-editor/components/tiptap-icons/smile-ai-icon";
import { CheckAiIcon } from "@/features/tiptap-editor/components/tiptap-icons/check-ai-icon";
