...
// --- Icons ---
import { BoldIcon } from "@/features/tiptap-editor/components/tiptap-icons/bold-icon";
import { Code2Icon } from "@/features/tiptap-editor/components/tiptap-icons/code2-icon";
import { ItalicIcon } from "@/features/tiptap-editor/components/tiptap-icons/italic-icon";
import { StrikeIcon } from "@/features/tiptap-editor/components/tiptap-icons/strike-icon";
import { SubscriptIcon } from "@/features/tiptap-editor/components/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "@/features/tiptap-editor/components/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "@/features/tiptap-editor/components/tiptap-icons/underline-icon";
