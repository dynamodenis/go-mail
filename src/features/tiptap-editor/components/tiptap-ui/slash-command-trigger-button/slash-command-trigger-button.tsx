...
// --- Tiptap UI ---
import type { UseSlashCommandTriggerConfig } from "@/features/tiptap-editor/components/tiptap-ui/slash-command-trigger-button";
import {
  SLASH_COMMAND_TRIGGER_SHORTCUT_KEY,
  useSlashCommandTrigger,
} from "@/features/tiptap-editor/components/tiptap-ui/slash-command-trigger-button";
