...
import { createTableDragImage } from "@/features/tiptap-editor/components/tiptap-node/table-node/extensions/table-handle/helpers/create-image";
...
class TableHandleView implements PluginView {
  ...
  update(view: EditorView): void {
    ...
    const indicesChanged =
      newRowIndex !== this.state.rowIndex ||
      newColIndex !== this.state.colIndex;
    const refPosChanged =
