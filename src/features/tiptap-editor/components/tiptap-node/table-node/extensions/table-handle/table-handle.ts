...
import type { TableHandlesState } from "@/features/tiptap-editor/components/tiptap-node/table-node/extensions/table-handle";
import {
  TableHandlePlugin,
  tableHandlePluginKey,
} from "@/features/tiptap-editor/components/tiptap-node/table-node/extensions/table-handle/table-handle-plugin";
