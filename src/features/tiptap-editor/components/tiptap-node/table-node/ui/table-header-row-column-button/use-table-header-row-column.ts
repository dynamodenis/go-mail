...
// --- Icons ---
import { TableHeaderRowIcon } from "@/features/tiptap-editor/components/tiptap-icons/table-header-row-icon";
import { TableHeaderColumnIcon } from "@/features/tiptap-editor/components/tiptap-icons/table-header-column-icon";
