...
// --- Icons ---
import { TableColumnIcon } from "@/features/tiptap-editor/components/tiptap-icons/table-column-icon";
import { TableRowIcon } from "@/features/tiptap-editor/components/tiptap-icons/table-row-icon";
