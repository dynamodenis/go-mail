...
import { cn, isValidPosition, SR_ONLY } from "@/features/tiptap-editor/lib/tiptap-utils";
import type { Orientation } from "@/features/tiptap-editor/components/tiptap-node/table-node/lib/tiptap-table-utils";
import { selectCellsByCoords } from "@/features/tiptap-editor/components/tiptap-node/table-node/lib/tiptap-table-utils";
...
// --- Tiptap UI ---
import { useTableDuplicateRowColumn } from "@/features/tiptap-editor/components/tiptap-node/table-node/ui/table-duplicate-row-column-button";
import { useTableMoveRowColumn } from "@/features/tiptap-editor/components/tiptap-node/table-node/ui/table-move-row-column-button";
...
import { useTableHeaderRowColumn } from "@/features/tiptap-editor/components/tiptap-node/table-node/ui/table-header-row-column-button";
import { useTableAddRowColumn } from "@/features/tiptap-editor/components/tiptap-node/table-node/ui/table-add-row-column-button";
import { useTableDeleteRowColumn } from "@/features/tiptap-editor/components/tiptap-node/table-node/ui/table-delete-row-column-button";
import { useTableSortRowColumn } from "@/features/tiptap-editor/components/tiptap-node/table-node/ui/table-sort-row-column-button";
...
import { dragEnd } from "@/features/tiptap-editor/components/tiptap-node/table-node/extensions/table-handle";
