...
// --- Lib ---
import { isExtensionAvailable } from "@/features/tiptap-editor/lib/tiptap-utils";
import type { Orientation } from "@/features/tiptap-editor/components/tiptap-node/table-node/lib/tiptap-table-utils";
import {
  getTable,
  getRowOrColumnCells,
} from "@/features/tiptap-editor/components/tiptap-node/table-node/lib/tiptap-table-utils";

// --- Icons ---
import { AlignLeftIcon } from "@/features/tiptap-editor/components/tiptap-icons/align-left-icon";
import { AlignCenterIcon } from "@/features/tiptap-editor/components/tiptap-icons/align-center-icon";
import { AlignRightIcon } from "@/features/tiptap-editor/components/tiptap-icons/align-right-icon";
import { AlignJustifyIcon } from "@/features/tiptap-editor/components/tiptap-icons/align-justify-icon";
import { AlignBottomIcon } from "@/features/tiptap-editor/components/tiptap-icons/align-bottom-icon";
import { AlignTopIcon } from "@/features/tiptap-editor/components/tiptap-icons/align-top-icon";
import { AlignMiddleIcon } from "@/features/tiptap-editor/components/tiptap-icons/align-middle-icon";
