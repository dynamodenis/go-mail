...
import { useTableHandleState } from "@/features/tiptap-editor/components/tiptap-node/table-node/hooks/use-table-handle-state";
...
import { cn } from "@/features/tiptap-editor/lib/tiptap-utils";

// --- Icons ---
import { PlusSmallIcon } from "@/features/tiptap-editor/components/tiptap-icons/plus-small-icon";

// --- Internal ---
import { useTableExtendRowColumnButtonsPositioning } from "@/features/tiptap-editor/components/tiptap-node/table-node/ui/table-extend-row-column-button/use-table-extend-row-column";
