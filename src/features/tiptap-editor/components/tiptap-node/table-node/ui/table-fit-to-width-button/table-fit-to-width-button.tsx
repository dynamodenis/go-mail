...
// --- Hooks ---
import { useTableFitToWidth } from "@/features/tiptap-editor/components/tiptap-node/table-node/ui/table-fit-to-width-button/use-table-fit-to-width";
import type { UseTableFitToWidthConfig } from "@/features/tiptap-editor/components/tiptap-node/table-node/ui/table-fit-to-width-button/use-table-fit-to-width";
