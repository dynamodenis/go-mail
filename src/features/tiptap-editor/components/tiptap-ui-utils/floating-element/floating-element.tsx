...
import { useFloatingElement } from "@/features/tiptap-editor/hooks/use-floating-element";
...
import { isElementWithinEditor } from "@/features/tiptap-editor/components/tiptap-ui-utils/floating-element";
import { isValidPosition } from "@/features/tiptap-editor/lib/tiptap-utils";
      ...
      zIndex,
      {
        ...
        dismissOptions: {
          ...
          outsidePress(event) {
            ...
            // Check if clicked within the editor
            if (isElementWithinEditor(editor, relatedTarget)) {
              return false;
            }

            // Check if clicked within the floating element itself (toolbar buttons)
            const floatingEl = floatingElementRef.current;
            if (floatingEl && (floatingEl === relatedTarget || floatingEl.contains(relatedTarget))) {
              return false;
            }
