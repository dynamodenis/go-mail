...
// -- Hooks --
import { useOnClickOutside } from "@/features/tiptap-editor/hooks/use-on-click-outside";
import { useComposedRef } from "@/features/tiptap-editor/hooks/use-composed-ref";
...
import { Label } from "@/features/tiptap-editor/components/tiptap-ui-primitive/label";
...
// -- Styles --
import "@/features/tiptap-editor/components/tiptap-ui-primitive/menu/menu.scss";
...
export const MenuItem = forwardRef<HTMLDivElement, MenuItemProps>(
  function MenuItem({ name, value, preventClose, className, ...props }, ref) {
    ...
    return <ComboboxItem ref={ref} {...itemProps} hideOnClick={hideOnClick} />;
  }
);
